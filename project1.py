...
#To view all hotels names
@app.route('/')
@app.route('/restaurants/')
def viewresname():
    restaurant = session.query(Restaurant).all()
    return render_template('viewres.html',restaurant=restaurant)


# menu w.r.t respective restaurant name
...
def newMenuItem(restaurant_id):
    if request.method == 'POST':
        ...
        session.add(newItem)
        session.commit()
        flash("new menu item created!") #flask representation
